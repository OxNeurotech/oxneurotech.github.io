	...
	<div class="relative min-h-[32rem] sm:min-h-96 lg:min-h-80">
		...
		>
			{#each projects.list as { project, competition, description, when, href, points }, i}
				<label
					for={project}
					class="h-10 min-w-36 border-b-[1px] border-gold-leaf-500 transition-all duration-700 first:rounded-l
						...
						<div>
							<div class="flex flex-wrap items-center space-x-1 text-lg">
								<div class="font-semibold leading-tight">
									<a
										{href}
										class="pointer-events-auto text-nowrap text-gold-leaf-200"
						...
						<div class="space-y-1">
							{#each points as point}
								<div class="flex gap-2">
									<div class=" my-auto text-gold-leaf-500">▹</div>
									<div>
										{@html point}
									</div>
								</div>
