...
>	
			...
			>
				{#each sections as section, i}
					<a
						...
						onclick={toggle}
					>
						<div class="text-center font-mono text-lg text-gold-leaf-400">
							{(i+1).toString()}.
						</div>
						<div
	...
	<div class="hidden md:flex">
		...
		{#each sections as section, i}
			...
			>
				<div class="text-center font-mono text-sm text-gold-leaf-600">
					{(i+1).toString()}.
				</div>
				<div
					class="text-center font-mono text-sm text-slate-400 transition duration-300 group-hover:text-gold-leaf-600"
				>
					{section}
				</div>
			</a>
